...
# conn = mysql.connect(host='127.0.0.1', user = 'root', passwd = "root", db = 'nbs', port = '3306')
...
class MatchWithDb:
    def __init__(self, reference, new_file, gender):
        ...
        self.curs = conn.cursor(buffered=True)
    ...
    #     self.ref_df.to_sql('variants', engine, 'nbs', if_exists='replace')
